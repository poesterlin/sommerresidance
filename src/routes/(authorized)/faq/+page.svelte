...
<ol>
	<li>
		<h2>Datum, Zeit und Ort der SOMMERRESIdance</h2>
		<p>
			Wir freuen uns, euch alle zu unserem einzigartigen Festival zu begrüßen, das am Wochenende vom <b>
				26. bis 28.07.2024
			</b>
			stattfindet.
		</p>
	...
	<li>
		...
		<p>
			...
			genügend Sonnenschutz und Sonnencreme mit. Bitte denkt daran, dass auch eine ausreichende Hydrierung wichtig ist!
			An der Wasserstelle könnt ihr euch mit frischem Leitungswasser versorgen.
		</p>
		<p>
			...
			Fall daran, einen Regenschutz mitzubringen.
		</p>
	</li>

	<li>
		<h2>Sicherheit und Notfallkontakte</h2>
